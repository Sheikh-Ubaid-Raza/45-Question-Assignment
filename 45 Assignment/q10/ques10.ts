...
//the program does. For comment use ( "//" ) at the begin,and for multiple line,select content( ctrl + / ) press

// Name: Ubaid                                                    //  Date: 24.07.2024

let favouriteNumber:number = 24;       //declare favouriteNumber

let message = `My Favourite Number is ${favouriteNumber}`;    

console.log(message);                // print "My Favourite Number is 24"
