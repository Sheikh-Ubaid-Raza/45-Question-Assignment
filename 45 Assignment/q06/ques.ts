...
let myName:string = "     Ubaid       ";

console.log(myName);           // print name with White Spaces

console.log(myName.trim());   //  '.trim()' => Remove White Spaces from begin and end of the string
